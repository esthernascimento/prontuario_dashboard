@extends('unidade.templates.unidadeTemplate') {{-- 🔥 CORREÇÃO: Template da unidade --}}

@section('title', 'Manutenção de Enfermeiros')

@section('content')
<link rel="stylesheet" href="{{ asset('css/unidade/manutencaoEnfermeiros.css') }}"> {{-- 🔥 CORREÇÃO: CSS da unidade --}}

@php $unidade = auth()->guard('unidade')->user(); @endphp {{-- 🔥 CORREÇÃO: Guard da unidade --}}
...
<main class="main-dashboard">
    <div class="enfermeiro-container">
        <div class="enfermeiro-header">
            ...
            {{-- 🔥 CORREÇÃO: Rota de cadastro da unidade --}}
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr data-status="{{ optional($enfermeiro->usuario)->statusAtivoUsuario == 1 ? 'ativo' : 'inativo' }}">
                        ...
                        <td class="actions">
                            {{-- 🔥 CORREÇÃO: Rota de edição da unidade --}}
...
<div id="statusEnfermeiroModal" class="modal-overlay">
    <div class="modal-content">
        ...
        {{-- 🔥 CORREÇÃO: Rota de alteração de status da unidade --}}
...
<script>
    ...
    function openStatusModal(enfermeiroId, enfermeiroNome, currentStatus) {
        ...
        // 🔥 CORREÇÃO: Atualizar a action do formulário com o ID correto
