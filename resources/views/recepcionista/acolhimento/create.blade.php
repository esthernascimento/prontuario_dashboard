...
{{-- ================================================================== --}}
{{-- --- ADICIONADO: Bloco para mostrar a mensagem de sucesso --- --}}
{{-- ================================================================== --}}
<div class="container-fluid"> {{-- Use container-fluid para largura total --}}
    <div class="row">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="form-label fs-5 mb-3">Classificação de Risco:</label>
                                <div id="botoes_risco" class="d-flex justify-content-between flex-wrap gap-2">
                                    
                                    <input type="radio" name="classificacao_risco" id="risco_vermelho" value="vermelho" class="btn-check" required>
                                    <label class="btn btn-danger btn-lg flex-fill m-1" for="risco_vermelho">VERMELHO (Emergência)</label>
                                    
                                    <input type="radio" name="classificacao_risco" id="risco_laranja" value="laranja" class="btn-check">
                                    <label class="btn btn-warning btn-lg flex-fill m-1" for="risco_laranja">LARANJA (Muito Urgente)</label>
                                    
                                    <input type="radio" name="classificacao_risco" id="risco_amarelo" value="amarelo" class="btn-check">
                                    <label class="btn btn-lg flex-fill m-1" for="risco_amarelo">AMARELO (Urgente)</label>
                                    
                                    <input type="radio" name="classificacao_risco" id="risco_verde" value="verde" class="btn-check">
                                    <label class="btn btn-success btn-lg flex-fill m-1" for="risco_verde">VERDE (Pouco Urgente)</label>
                                    
                                    <input type="radio" name="classificacao_risco" id="risco_azul" value="azul" class="btn-check">
                                    <label class="btn btn-primary btn-lg flex-fill m-1" for="risco_azul">AZUL (Não Urgente)</label>
                                </div>
                            </div>
                        </div>
                    </div>
